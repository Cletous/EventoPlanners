# EventoPlanners - Manual System Testing Guide
...
When a case fails, give it a short defect ID such as `DEF-001`, record the observed result in the CSV, and preserve enough reproduction steps to repeat it.
